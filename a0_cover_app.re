...
font.cのfont_bitmap配列は、各文字のインデックスが"FONT_<元画像ファイル名>"という定数となるように生成されます。"FONT_<元画像ファイル名>"の定数はfont.hにenumで宣言されていますので、font_bitmap配列内の文字のインデックスを固定する場合はfont.hのenum宣言部分を変更してください。どう変更すれば良いかについては"A00_cover_app"内のfont.hを見てみてください。
