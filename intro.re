...
本書は64ビットのx86 CPU(x86_64)を対象にフルスクラッチで"OS"を作ってみる本です。本書では主に"カーネル"と呼ばれるハードウェアの機能を上位のアプリケーションに向けて抽象化する部分を作ってみます。アーキテクチャとしては@<img>{intro_arch}の通りです。

//image[intro_arch][本書で作るOSのアーキテクチャ]{
//}
